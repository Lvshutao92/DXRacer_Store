...
- (void)createViews {
    ...
    /******自定义界面******/
    _navigationBar = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.bounds.size.width, [Manager returnDaohanglanHeight])];
    _navigationBar.backgroundColor = [UIColor colorWithWhite:.99 alpha:.05];
...
//    [_navigationBar addSubview:backImageView];
    ...
    backBtn.frame = CGRectMake(27, [Manager returnDianchitiaoHeight], 40, 30);
    [backBtn setTitle:@"返回" forState:UIControlStateNormal];
    [backBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
    [backBtn addTarget:self action:@selector(goBack) forControlEvents:UIControlEventTouchUpInside];
    [_navigationBar addSubview:backBtn];
    
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(80, [Manager returnDianchitiaoHeight], self.view.bounds.size.width-160, 30)];
...
//    _tabBar.backgroundColor = [UIColor colorWithWhite:.99 alpha:.05];
...
//    [self.view addSubview:_tabBar];
    ...
    sendImageBtn.frame = CGRectMake(SCREEN_WIDTH-67, [Manager returnDianchitiaoHeight], 40, 30);
    [sendImageBtn setTitle:@"保存" forState:UIControlStateNormal];
    ...
    [_navigationBar addSubview:sendImageBtn];
}
